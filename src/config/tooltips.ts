...
export const tooltips = {
  ...
  navigation: {
    modeSwitcher: 'Switch between editing your Resume or Cover Letter - both share personal information',
  ...
  // Section Headers
  sections: {
    importExport: 'Upload existing JSON Resume data or download your current resume/cover letter',
    aiSettings: 'Configure OpenAI-compatible API for AI-powered content generation',
    personalInfo: 'Your name, contact details, and professional summary - shared across all documents',
    socialMedia: 'Add links to LinkedIn, GitHub, Portfolio, and other professional profiles',
    summary: 'A brief professional overview highlighting your key strengths and experience',
    education: 'Your degrees, certifications, and academic achievements',
    workExperience: 'Your employment history with responsibilities and achievements',
    skills: 'Organize your technical and professional skills into categories',
    additionalInfo: 'Certifications, languages, projects, and other relevant information',
    coverLetterContent: 'Write a compelling cover letter tailored to your target job',
    projects: 'Showcase your personal projects, open source contributions, and side hustles',
  },

  // AI Settings Form
  aiSettings: {
    apiUrl: 'URL of your OpenAI-compatible API endpoint (e.g., http://localhost:1234 for local LLMs)',
    apiKey: 'Your API key for authentication - stored locally in your browser only',
    model: 'The AI model to use (e.g., gpt-4o-mini, llama-3, mistral) - must be available on your API',
    jobDescription: 'Paste the full job posting - AI uses this to tailor your content to the role',
    rememberCredentials: 'Save API credentials in browser localStorage for future sessions',
    ...
    invalidStatus: 'Connection failed - check your API URL, key, and model name',
  ...
  importExport: {
    ...
    downloadResume: 'Download your resume data in JSON Resume format (compatible with many tools)',
    downloadCoverLetter: 'Download your cover letter with personal info in JSON format',
    fileFormat: 'Use standard JSON Resume format (jsonresume.org) for maximum compatibility',
  },

  // Personal Information
  personalInfo: {
    profilePicture: 'Upload a professional headshot (appears on resume preview)',
    name: 'Your full name as it should appear on your resume',
    position: 'Your current or target job title (e.g., "Senior Software Engineer")',
    email: "Professional email address - ensure it's active and monitored",
    phone: 'Phone number with country code if applying internationally (e.g., +1-555-123-4567)',
  ...
  // Summary
  summary: {
    textarea: 'Write 2-4 sentences highlighting your experience, skills, and career goals',
    aiGenerate: 'Let AI write a tailored summary based on your resume and the job description',
  ...
  education: {
    ...
    degree: 'Your degree type and major (e.g., "Bachelor of Science in Computer Science")',
    startDate: 'When you started this program (YYYY-MM format)',
    endDate: 'When you graduated or expect to graduate (leave empty if currently enrolled)',
    gpa: 'Your cumulative GPA (optional - only include if 3.5 or higher)',
    courses: 'Relevant coursework that demonstrates skills for your target role',
  ...
  workExperience: {
    ...
    summary: 'Brief description of your role and responsibilities (1-2 sentences)',
    keyAchievements: 'Specific accomplishments with measurable impact (use action verbs and metrics)',
    ...
    toggleTechnologies: 'Show or hide technologies section for this work experience',
    removeEntry: 'Delete this work experience from your resume',
  },

  // Skills
  skills: {
    addGroup: 'Create a new skill category (e.g., "Frontend", "Backend", "DevOps")',
    ...
    highlightSkill: 'Bold this skill to emphasize proficiency or relevance to the job',
  ...
  languages: {
    ...
    proficiency: 'Your skill level: Native, Fluent, Advanced, Intermediate, or Basic',
  ...
  projects: {
    ...
    description: 'Brief explanation of what the project does and your role (2-3 sentences)',
    achievements: 'Key technical achievements or impact metrics (downloads, stars, users)',
  ...
  // Cover Letter
  coverLetter: {
    content: "Write a compelling letter explaining why you're a great fit for this specific role",
    aiGenerate: 'Let AI draft a tailored cover letter based on your resume and the job description',
    paragraphGuidance: "Aim for 3-4 paragraphs: (1) Introduction, (2-3) Why you're qualified, (4) Call to action",
  },

  // AI Generation
  aiGeneration: {
    generateButton: 'Use AI to generate content - requires valid AI Settings configuration',
    regenerateButton: 'Generate new content with AI (replaces current text)',
    jobDescriptionRequired: 'Enter a job description in AI Settings to enable AI generation',
    streaming: 'AI is generating content in real-time - you can stop at any time',
...
/**
 * Type representing the structure of the centralized tooltip configuration.
 */
