...
describe('useProjectAchievementsForm', () => {
  ...
  describe('Initialization', () => {
    it('returns achievements for the specified project index', () => {
      const { result } = renderHook(() => useProjectAchievementsForm(0), {
    ...
    it('returns achievements for different project indices', () => {
      const { result } = renderHook(() => useProjectAchievementsForm(1), {
        wrapper: createWrapper(mockResumeData),
      })
    ...
    it('throws error if project index does not exist', () => {
      ...
      expect(() => {
        renderHook(() => useProjectAchievementsForm(999), {
          wrapper: createWrapper(mockResumeData),
        })
  ...
  describe('add', () => {
    it('adds new achievement with provided text', () => {
      ...
      expect(newData.projects[0].keyAchievements[3]).toEqual({
