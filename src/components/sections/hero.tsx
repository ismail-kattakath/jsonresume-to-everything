  ...
  return (
    <section className="relative flex min-h-screen items-center overflow-hidden backdrop-blur-sm">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-6 py-24">
        <m.div variants={containerVariants} initial="hidden" animate="visible" className="text-center">
          {/* Profile Image with enhanced styling */}
          <m.div variants={itemVariants} className="relative mb-8 inline-block">
          ...
          {/* Position with icon */}
          <m.div variants={itemVariants} className="mb-6 flex items-center justify-center gap-2">
          ...
          {/* Primary CTAs */}
          <m.div variants={itemVariants} className="mb-8 flex flex-wrap items-center justify-center gap-4">
            <m.a
              href="#contact"
          ...
          {/* Social links */}
          <m.div variants={itemVariants} className="flex items-center justify-center gap-3">
            <m.a
              href={linkedInUrl}
              target="_blank"
