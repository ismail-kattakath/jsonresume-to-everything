...
describe('generateResumeBuilderOgImage', () => {
  ...
  beforeEach(() => {
    ...
    ;(ImageResponse as unknown as jest.Mock).mockImplementation((element, options) => ({
      element,
      options,
    }))
  })
  ...
  describe('Error Handling', () => {
    it('should handle file read errors', async () => {
      ...
      await expect(generateResumeBuilderOgImage(config)).rejects.toThrow('File not found')
    })
  })
