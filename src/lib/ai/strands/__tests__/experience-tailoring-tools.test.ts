import { validateAchievementsTool } from '../experience-tailoring/tools/validate-achievements.tool'
import { validateTechStackTool } from '../experience-tailoring/tools/validate-tech-stack.tool'
import { validateDescriptionTool } from '../experience-tailoring/tools/validate-description.tool'
...
describe('Experience Tailoring Tools', () => {
    ...
    describe('validateDescriptionTool', () => {
        it('should pass properly rewritten description', () => {
            ...
            const rewritten = 'Key contributor to backend web services APIs handling thousands of daily active users, built scalable infrastructure spanning cloud environments.'
